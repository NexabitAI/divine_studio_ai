    ...
    return (
        <section className='max-w-7xl mx-auto'>
            <div className='justify-center text-center'>
                ...
                <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-black md:text-5xl lg:text-6xl">Divine Studio<span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Text-to-Image</span> AI Generatorssssde.</h1>
